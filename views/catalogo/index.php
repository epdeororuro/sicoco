          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <span class="float-right"> 
               <button type="button" id="btnNuevoRegistro" class="btn btn-primary btn-lm" data-toggle="modal" data-target="#ModalCatalogo">
        ...
        <div id="ModalCatalogo" class="modal fade" role="dialog">
          ...
          <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
              <div class="modal-header bg-primary text-white" id="header_modal_catalogo">
